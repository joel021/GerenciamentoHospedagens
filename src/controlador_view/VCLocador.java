 ...
 * @author Joel
 */
public class VCLocador extends VCLocadores {

    private ArrayList<Mensagem> mensagens;
    private static HashMap<Lugar, Espaco> agendamentos;
    ...
    private boolean l_mensagens, l_contatos, l_agendamentos, l_espacos;
     ...
     * @param m
     */
    public VCLocador(Locador contexto, ControladorMain m) {
        ...
        setTitle("Interfacie de Locador: "+contexto.getNome());
                ...
                if(e.getClickCount() == 1){
                    ...
                    if(e.getClickCount() == 1){
                        ...
                        if(vcEspacoInfo == null){
                            vcEspacoInfo = new VCEspacoInfo(contexto, VCLocador.this, m);
                        }
                        ...
                        vcEspacoInfo.setText_lugares(rPesquisa.get(i).getLugaresLivres()+"");
            ...
            public void mouseClicked(MouseEvent e){
                if(e.getClickCount() == 1){
                    ...
                    if(vcEspacoLocador == null){
                        vcEspacoLocador = new VCEspacoLocador(contexto, VCLocador.this, m);
                    }
            ...
            public void mouseClicked(MouseEvent e){
                if(e.getClickCount() == 1){
                    ...
                    if(vcAgendamentoInfo == null){
                        vcAgendamentoInfo = new VCAgendamentoInfo(contexto, VCLocador.this, m);
                    }
    ...
    public void setEspacosLocador(ArrayList<Espaco> espacos){
        ...
        if(!espacos.isEmpty()){
            ...
            for(Espaco espaco: espacos){
                modelo.addElement(espaco.getTipo()+" - "+espaco.getEndereco()+" - R$"+espaco.getDiaria()+" - "+espaco.getnLugares()+" lugares, "+espaco.getLugaresReservados().size()+" ocupados");
            }
    ...
    public void setAgendamentos(HashMap<Lugar, Espaco> agendamentos) {
        VCLocador.agendamentos = agendamentos;
    ...
    private void initComponents() {
        ...
        text_lucro.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(text_lucro, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jScrollPane3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 341, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
        ...
        jPanel6.setMaximumSize(new java.awt.Dimension(358, 32767));

        button_sair.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        jLabel13.setText("Total gasto R$: ");
    ...
    @Override
    public void setLucro(String text_lucro) {
        this.text_lucro.setText(text_lucro);
    }
